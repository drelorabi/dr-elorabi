...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  function setProStatus(
    ...
    if (
      ...
      title.textContent =
        "طلب PRO قيد المراجعة";

      text.textContent =
        "تم استلام طلب الدفع وجاري مراجعته";
    ...
    text.textContent =
      "اشترك في PRO للحصول على المميزات الكاملة";
    ...
    try {
      ...
      const {
        ...
        await supabaseClient
          ...
          .select(
            "id,status,admin_note,created_at,reviewed_at"
          )
          .eq(
            "user_id",
            user.id
